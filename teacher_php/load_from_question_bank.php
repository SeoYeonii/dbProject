...
<head>
  ...
  <script>
    function check()
    {
     if ($("#q_n").is(":checked")==false && $("#dif").is(":checked")==false && $("#sco").is(":checked")==false
   && $("#keyw").is(":checked")==false) {
       alert("적어도 한 개는 체크해주세요!");
       return false;
      }
      if ($("#q_n").is(":checked")) {
        var name = $.trim($('#a').val());
...
?>
  ...
  <br />
  <input type="checkbox" id="q_n" checked> 문항 수
  <input type="checkbox" id="dif"> 평균 난이도
  <input type="checkbox" id="keyw"> 키워드
  <br />
